var datasource = {
  ...
  'title': ' Opensource.lk',
  'children': [
    { 'name': 'KARSHA', 'title': 'Financial Data Analytics' ,'className': 'main-project',
      'children' : [
        { 'name': 'FinNetwork', 'title': 'Network Analytics' , 'className': 'sub-project'},
        { 'name': 'PricePattern', 'title': 'Pattern Analytics','className': 'sub-project'}
      ]
    },
